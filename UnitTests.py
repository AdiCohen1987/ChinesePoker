...
import Cards
import Game
from GameLogic import evaluate
...
class TestHandsEvaluation(unittest.TestCase):
    def test_royalFlush(self):
        ...
        self.assertEqual(evaluate(hand), {10: []})
    ...
    def test_straightFlush(self):
        ...
        self.assertEqual(evaluate(hand), {9: [13]})
    ...
    def test_fourOfAKind(self):
        ...
        hand.addCard(Cards.Card(9, 'S'))
        self.assertEqual(evaluate(hand), {8: [12,9]})
    ...
    def test_fullHouse(self):
        ...
        self.assertEqual(evaluate(hand), {7: [11,5]})
    ...
    def test_flush(self):
        ...
        self.assertEqual(evaluate(hand), {6: [13,11,10,7, 4]})
    ...
    def test_straight(self):
        ...
        self.assertEqual(evaluate(hand), {5: [5]})
    ...
    def test_threeOfAKind(self):
        ...
        hand.addCard(Cards.Card(5, 'C'))
        hand.addCard(Cards.Card(2, 'S'))
        self.assertEqual(evaluate(hand), {4: [5,14,2]})
    ...
    def test_twoPairs(self):
        ...
        self.assertEqual(evaluate(hand), {3: [9,8,10]})
    ...
    def test_pair(self):
        ...
        hand.addCard(Cards.Card(4, 'S'))
        self.assertEqual(evaluate(hand), {2: [4,10,9,7]})
    ...
    def test_highCard(self):
        ...
        hand.addCard(Cards.Card(5, 'C'))
        hand.addCard(Cards.Card(4, 'S'))
        self.assertEqual(evaluate(hand), {1: [12,9,7,5,4]})
